...
See [.github/workflows/release.yml](.github/workflows/release.yml:77).

## Local placeholder file

A tracked example file lives at:

- [.env.release.local.example](.env.release.local.example:1)
...
- `plugins.updater.pubkey` in [src-tauri/tauri.conf.json](src-tauri/tauri.conf.json:64)
- the GitHub Releases endpoint / owner in [src-tauri/tauri.conf.json](src-tauri/tauri.conf.json:66)
